...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($id_rt) || empty($id_kepala_keluarga) || empty($pemasukan_perbulan)) {
        echo 'data_tidak_lengkap';
        exit;
    }

    // Cek apakah username sudah ada di database
    $check_query = "SELECT * FROM keluarga_kurang_mampu WHERE id_kepala_keluarga = '$id_kepala_keluarga'";
    ...
    $query = "INSERT INTO keluarga_kurang_mampu (id_rt, id_kepala_keluarga, pemasukan_perbulan, status_validasi, foto_rumah, foto_keluarga) 
              VALUES ('$id_rt', '$id_kepala_keluarga', '$pemasukan_perbulan', '$status_validasi', '$foto_rumah', '$foto_keluarga')";
