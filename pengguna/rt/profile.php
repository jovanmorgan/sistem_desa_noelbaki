                                            ...
                                            <li class="mb-2">
                                                <a class="dropdown-item border-radius-md" href="profile">
                                                    <div class="d-flex py-1">
                                                        <div class="my-auto">
                                                            <?php if (!empty($rt['fp'])): ?>
                                                                <img src="../../assets/img-umum/foto_profile/<?php echo $rt['fp']; ?>"
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="text-sm font-weight-normal mb-1 text-black">
                                                                Hay, <span class="font-weight-bold text-black"><span
                                                                        class="text-black">RT :
                                                                        <?php echo $rt['nama_rt']; ?></span>
                                                                    (<?php echo $rt['nama_lengkap']; ?>)</span>
                                                            </h6>
                                ...
                                <div class="card card-profile">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="text-center mt-4">
                                            <h5 class="mb-3"><?php echo $rt['nama_lengkap']; ?></h5>
                                            <table class="table table-borderless text-start">
                                                <tbody>
                                                    <tr>
                                                        <th class="text-muted"><i class="fa fa-user"></i></th>
                                                        <td>
                                                            <?php echo "RT :" . $rt['nama_rt'] ? "RT : " . $rt['nama_rt'] : '<p class="text-danger">~Belum diisi~</p>'; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-muted"><i class="fa fa-user"></i></th>
                                                        <td><?php echo $rt['username'] ? $rt['username'] : '<p class="text-danger">~Belum diisi~</p>'; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-muted"><i class="fa fa-lock"></i></th>
                                                        <td><?php echo $rt['password'] ? $rt['password'] : '<p class="text-danger">~Belum diisi~</p>'; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-muted"><i class="fa fa-male"></i>/<i
                                                                class="fa fa-female"></i></th>
                                                        <td><?php echo $rt['jenis_kelamin'] ? $rt['jenis_kelamin'] : '<p class="text-danger">~Belum diisi~</p>'; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-muted"><i class="fa fa-map-marker-alt"></i></th>
                                                        <td><?php echo $rt['alamat'] ? $rt['alamat'] : '<p class="text-danger">~Belum diisi~</p>'; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-muted"><i class="fa fa-briefcase"></i></th>
                                                        <td><?php echo $rt['jabatan'] ? $rt['jabatan'] : '<p class="text-danger">~Belum diisi~</p>'; ?>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <form id="editProfileForm">
                                        <div class="card-body">
                                            <div class="row">
                                                <input type="text" name="id_rt" id="id_rt" value="<?php echo $rt['id_rt']; ?>"
                                                    hidden>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" value="<?php echo $rt['nama_rt']; ?>"
                                                            id="nama_rt" name="nama_rt" class="form-control"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="nama_lengkap" name="nama_lengkap"
                                                            class="form-control" value="<?php echo $rt['nama_lengkap']; ?>"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <!-- select option nya jika sama dengan <?php echo $rt['jenis_kelamin']; ?>  -->
                                                        <select class="form-select" name="jenis_kelamin" id="jenis_kelamin"
                                                            required>
                                                            <option value="" disabled selected>Pilih jenis kelamin</option>
                                                            <option value="pria"
                                                                <?php echo $rt['jenis_kelamin']  == 'pria' ? 'selected' : ''; ?>>
                                                                Pria
                                                            </option>
                                                            <option value="wanita"
                                                                <?php echo $rt['jenis_kelamin']  == 'wanita' ? 'selected' : ''; ?>>
                                                                Wanita
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="username" name="username" class="form-control"
                                                            placeholder="Masukkan username" value="<?php echo $rt['username']; ?>"
                                                            required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="password" name="password" class="form-control"
                                                            placeholder="Masukkan password" value="<?php echo $rt['password']; ?>"
                                                            required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea class="form-control" id="alamat" name="alamat" rows="3"
                                                            ...
                                                            required><?php echo $rt['alamat']; ?></textarea>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-select" name="jabatan" id="jabatan" required>
                                                            ...
                                                            <option value="Ketua RT"
                                                                <?php echo $rt['jabatan'] == 'Ketua RT' ? 'selected' : ''; ?>>Ketua
                                                                RT</option>
                                                            <option value="Wakil Ketua RT"
                                                                <?php echo $rt['jabatan'] == 'Wakil Ketua RT' ? 'selected' : ''; ?>>
