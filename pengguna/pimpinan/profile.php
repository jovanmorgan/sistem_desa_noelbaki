                                                    ...
                                                    <div class="d-flex py-1">
                                                        <div class="my-auto">
                                                            <?php if (!empty($pimpinan['fp'])): ?>
                                                                <img src="../../assets/img-umum/foto_profile/<?php echo $pimpinan['fp']; ?>"
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="text-sm font-weight-normal mb-1 text-black">
                                                                Hay, <span
                                                                    class="font-weight-bold text-black"><?php echo $pimpinan['nama_lengkap']; ?></span>
                                                            </h6>
                                ...
                                <div class="card card-profile">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="text-center mt-4">
                                            <h5 class="mb-3"><?php echo $pimpinan['nama_lengkap']; ?></h5>
                                            <table class="table table-borderless text-start">
                                                <tbody>
                                                    <tr>
                                                        <th class="text-muted"><i class="fa fa-user"></i></th>
                                                        <td><?php echo $pimpinan['username'] ? $pimpinan['username'] : '<p class="text-danger">~Belum diisi~</p>'; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-muted"><i class="fa fa-lock"></i></th>
                                                        <td><?php echo $pimpinan['password'] ? $pimpinan['password'] : '<p class="text-danger">~Belum diisi~</p>'; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-muted"><i class="fa fa-male"></i>/<i
                                                                class="fa fa-female"></i></th>
                                                        <td><?php echo $pimpinan['jenis_kelamin'] ? $pimpinan['jenis_kelamin'] : '<p class="text-danger">~Belum diisi~</p>'; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-muted"><i class="fa fa-phone"></i></th>
                                                        <td><?php echo $pimpinan['no_telpon'] ? $pimpinan['no_telpon'] : '<p class="text-danger">~Belum diisi~</p>'; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-muted"><i class="fa fa-briefcase"></i></th>
                                                        <td><?php echo $pimpinan['jabatan'] ? $pimpinan['jabatan'] : '<p class="text-danger">~Belum diisi~</p>'; ?>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <form id="editProfileForm">
                                        <div class="card-body">
                                            <div class="row">
                                                <input type="text" name="id_pimpinan" id="id_pimpinan"
                                                    value="<?php echo $pimpinan['id_pimpinan']; ?>" hidden>
                                                <!-- Nama Lengkap -->
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="nama_lengkap" name="nama_lengkap"
                                                            class="form-control" value="<?php echo $pimpinan['nama_lengkap']; ?>"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <!-- select option nya jika sama dengan <?php echo $pimpinan['jenis_kelamin']; ?>  -->
                                                        <select class="form-select" name="jenis_kelamin" id="jenis_kelamin"
                                                            required>
                                                            <option value="" disabled selected>Pilih jenis kelamin</option>
                                                            <option value="pria"
                                                                <?php echo $pimpinan['jenis_kelamin']  == 'pria' ? 'selected' : ''; ?>>
                                                                Pria
                                                            </option>
                                                            <option value="wanita"
                                                                <?php echo $pimpinan['jenis_kelamin']  == 'wanita' ? 'selected' : ''; ?>>
                                                                Wanita
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="username" name="username" class="form-control"
                                                            ...
                                                            value="<?php echo $pimpinan['username']; ?>" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="password" name="password" class="form-control"
                                                            ...
                                                            value="<?php echo $pimpinan['password']; ?>" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" id="no_telpon" name="no_telpon"
                                                            ...
                                                            value="<?php echo $pimpinan['no_telpon']; ?>" required>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-select" name="jabatan" id="jabatan" required>
                                                            ...
                                                            <option value="Kepala Desa"
                                                                <?php echo $pimpinan['jabatan'] == 'Kepala Desa' ? 'selected' : ''; ?>>
                                                                Kepala Desa</option>
                                                            <option value="Sekertaris"
                                                                <?php echo $pimpinan['jabatan'] == 'Sekertaris' ? 'selected' : ''; ?>>
                                                                Sekertaris</option>
                                                        </select>
                                                    </div>
                                                </div>
