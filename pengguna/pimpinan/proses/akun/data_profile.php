...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE admin SET password='$password', nama_lengkap='$nama_lengkap', username='$username', jenis_kelamin='$jenis_kelamin', no_telpon='$no_telpon', jabatan='$jabatan' WHERE id_admin='$id_admin'";
