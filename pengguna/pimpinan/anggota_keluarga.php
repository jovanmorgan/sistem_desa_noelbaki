...
";
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="tambahForm" method="POST" action="proses/<?= $page_title_proses ?>/tambah.php"
                            ...
                            <div class="mb-3">
                                <label for="id_kepala_keluarga" class="form-label">Kepala Keluarga</label>
                                <select class="form-select" id="id_kepala_keluarga" name="id_kepala_keluarga" required>
                                    ...
                                    while ($row = $result->fetch_assoc()): ?>
                                        <option value="<?php echo $row['id_kepala_keluarga']; ?>">
                                            ...
                                            <?php echo $row['nomor_induk_kartu_keluarga']; ?>)</option>
                                    <?php endwhile; ?>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="nik_anggota_keluarga" class="form-label">Nomor Induk Kependudukan</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                    <input type="text" id="nik_anggota_keluarga" name="nik_anggota_keluarga"
                                        class="form-control" placeholder="Masuakan Nomor Induk Kependudukan" required
                                        maxlength="16"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="nama_lengkap" name="nama_lengkap" class="form-control"
                                        placeholder="Masuakan nama lengkap" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" id="tempat_lahir" name="tempat_lahir" rows="3"
                                        placeholder="Masuakan tempat lahir" required></textarea>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editForm" method="POST" action="proses/<?= $page_title_proses ?>/edit.php"
                            enctype="multipart/form-data">
                            <input type="hidden" id="edit_id" name="id_anggota_keluarga">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                    <input type="text" id="edit_nik_anggota_keluarga" name="nik_anggota_keluarga"
                                        class="form-control" placeholder="Masuakan Nomor Induk Kependudukan" required
                                        maxlength="16"
                                        oninput="this.value = this.value.replace(/\D/g, '').slice(0, 16);" />
                                </div>
    ...
    <script>
        function openEditModal(id, id_kepala_keluarga, nama_lengkap, nik_anggota_keluarga, jenis_kelamin,
            ...
            document.getElementById('edit_nik_anggota_keluarga').value = nik_anggota_keluarga;
