...
";
        ...
        // Query untuk mendapatkan data jenis bantuan berdasarkan RT
        $query_jenis_bantuan = "
    SELECT 
        kk.id_rt,
        rt.nama_rt,
...
";
        ...
        // Query untuk menghitung pemasukan per bulan berdasarkan RT
        $query_pemasukan = "
    SELECT 
        kk.id_rt,
        rt.nama_rt,
...
";
        ...
        // Query untuk mendapatkan data status validasi berdasarkan RT
