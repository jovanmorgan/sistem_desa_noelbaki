...
$id_pimpinan = $_POST['id_pimpinan']; // Pastikan ID pimpinan dikirim untuk proses update
...
// Cek apakah username sudah ada di database
$check_query_pimpinan = "SELECT * FROM pimpinan WHERE username = '$username' AND id_pimpinan != '$id_pimpinan'";
