 <div id="load_data">
     ...
     <?php
        ...
        $query = "
                                SELECT * 
                                FROM majelis 
                                WHERE jenis_kelamin LIKE ? OR nama_lengkap LIKE ? OR alamat LIKE ? OR umur LIKE ?
                                LIMIT ?, ?
                            ";
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="display: flex; justify-content: center; gap: 10px;">
                                                     <button class="btn btn-primary btn-sm"
                                                         onclick="openEditModal('<?php echo $row['id_majelis']; ?>','<?php echo $row['nama_lengkap']; ?>', '<?php echo $row['jenis_kelamin']; ?>', '<?php echo $row['alamat']; ?>','<?php echo $row['umur']; ?>')">Edit</button>
